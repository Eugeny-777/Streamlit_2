...
**Выберите столбец/ы отображаемые по оси Y:** можно задать 1 или несколько числовых или дата столбцов.\
*в следующих версиях надо сделать проверку, что одновременно можно добавлять данные только одного типа, т.к. вывод, к примеру, стоимости и даты на одной шкале будет не очень корректным*\
